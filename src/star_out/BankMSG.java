...
public class BankMSG {
	public static String MSG_CURRACCOUNT 		= "현재 계좌는 %s님의 계좌입니다.%n";
	public static String MSG_CHOICETASK 		= "업무를 선택해주세요.%n";
	public static String MSG_TYPEINFO 			= "정보를 입력해주세요. (계좌번호,이름,잔액)%n";
	public static String MSG_MKACCOUNT 			= "계좌가 개설되었습니다.%n";
	public static String MSG_INPUTNAME 			= "이름을 입력하세요.%n";
	...
	public static String ERR_CANTFINDNAME 		= "[E] 일치하는 이름이 없습니다.%n";
